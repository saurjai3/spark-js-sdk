...
export default class Meeting {
  ...
  getLocalMedia(options) {
    ...
    return Promise.try(() => /* Media.getScreenShare(sendShare))
      .then((screenConstraints) => Media.getMedia(false, screenConstraints))
      .then((screen) => */ Media.getMedia(sendAudio, sendVideo).then((media) => [media, undefined])); // TODO define undefined as screen pc
  }
  ...
  join(options) {
    ...
    return this.joinMeeting()
      ...
      .then((streams) => this.addMedia(streams))
